...
public:
	...
	void faulForYellowCard(Team team, char* getFirstName());
	void faulForRedCard(Team team, char* getFirstName());
	void faulForNoCard(Team team, char* getFirstName());

	bool checkIfPlayerHasYellowCard(Player player);
